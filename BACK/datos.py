    ...
    def agregar(self):
        ...
        while True:
            try:
                ...
                break     
        email = input(Col.amarillo + "Email: " + Col.finColor)
        telefono = input(Col.amarillo + "Teléfono: " + Col.finColor)

        usario = Contacto(dni, nombre, apellido, deposito, retiro, email, telefono)
